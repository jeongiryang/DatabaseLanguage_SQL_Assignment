...
1. [과제 요구사항](#1-과제-요구사항)
2. [인증 스크린샷](#2-인증-스크린샷)
    - [2.1 본인 컴퓨터 설치 및 IP 인증](#21-본인-컴퓨터-설치-및-ip-인증)
    - [2.2 과제 단계별 실행 결과](#22-과제-단계별-실행-결과)
3. [SQL 쿼리 첨부](#3-sql-쿼리-첨부)
    - [3.1 테이블 생성 (DDL)](#31-테이블-생성-ddl)
    - [3.2 데이터 입력 (DML)](#32-데이터-입력-dml)
    - [3.3 과제 요구 조회 쿼리](#33-과제-요구-조회-쿼리)
...
| [01] 과제 제출 기본 요건 | [02] DDL 및 DML 작성 조건 |
| :---: | :---: |
| ![Requirement 1](./screenshots/과제요구사항1%20(1).png) | ![Requirement 2](./screenshots/과제요구사항1%20(2).png) |
| ▲ MariaDB 로컬 설치, IP 인증 및 전체 SQL 첨부 | ▲ 4개 테이블 스키마 정의 및 테이블별 데이터 10건 이상 입력 |

| [03] 질의문(Query) 작성 조건 |
| :---: |
| ![Requirement 3](./screenshots/과제요구사항1%20(3).png) |
| ▲ 서브쿼리 및 그룹화를 활용한 6가지 질의 요구사항 해결 |
