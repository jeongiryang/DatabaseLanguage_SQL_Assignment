...
##  목차
1. [인증 스크린샷](#1-인증-스크린샷)
    - [1.1 본인 컴퓨터 설치 및 IP 인증](#11-본인-컴퓨터-설치-및-ip-인증)
    - [1.2 과제 단계별 실행 결과](#12-과제-단계별-실행-결과)
2. [SQL 쿼리 첨부](#2-sql-쿼리-첨부)
    - [2.1 테이블 생성 (DDL)](#21-테이블-생성-ddl)
    - [2.2 데이터 입력 (DML)](#22-데이터-입력-dml)
    - [2.3 과제 요구 조회 쿼리](#23-과제-요구-조회-쿼리)
